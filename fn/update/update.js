...
const handler = async (event) => {
  ...
  <text fill="white" y="0" xml:space="preserve" style="white-space: pre" font-family="sans-serif" font-size="40" font-weight="600" letter-spacing="0em">
    <tspan x="60%" y="0" text-anchor="middle">
  ${song.slice(0, 20)}
  </tspan>
  </text>
  <defs>
